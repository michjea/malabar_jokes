...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        jokeRepository.save(new Joke(jokes[9][0], jokes[0][1], date, user3));
    ...
    private String[][] jokes = {
            ...
            { "Chèvres",
                    "Quel club de football les chèvres aiment-t-elles ? Beeeeee-nfica" },
            { "Dark humour",
            ...
            { "Programmer pro tip",
                    "Code Java underwater, so nobody could see you crying." },
